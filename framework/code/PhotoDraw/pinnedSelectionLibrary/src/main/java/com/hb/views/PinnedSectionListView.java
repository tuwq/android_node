...
public class PinnedSectionListView extends ListView {
    ...
    void createPinnedShadow(int position) {
        ...
        LayoutParams layoutParams2 = (LayoutParams) pinnedView.getLayoutParams();
        pinnedView = new Button(getContext());
        ((Button)pinnedView).setText("我是固定头:"+position);
        pinnedView.setLayoutParams(layoutParams2);
